...
def actions(userquestion, response):
...
class actionTool(BaseTool):
    ...
    def _run(self, question: str, response: str, *args, **kwargs):
        return actions(question, response)
...
api = Api(app, version='1.0', title='Gemi', description='Gemi Functions Agent', doc='/api/doc')
...
def setupPrompt(userinfo, agentlocation):
...
class Chat(Resource):
    ...
    def post(self):
        try:
            ...
            prompt = setupPrompt(userinfo, agentlocation)
